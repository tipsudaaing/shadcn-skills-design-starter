...
## Steps
1. Read `../_resources/workflows/design-review.md` (rubric, scoring guide, Nielsen heuristics, process).
...
4. Run the accessibility lens with `../_resources/accessibility/wcag-checklist.md`; use `../_resources/scripts/contrast.py` for any color-pair doubts.
5. Check against the anti-slop tells in `../_resources/taste/design-taste.md` (Banned Defaults checklist).
