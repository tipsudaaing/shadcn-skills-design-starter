...
## Steps
1. Read `../_resources/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`../_resources/tokens/*`), components (`../_resources/components/*`), taste (`../_resources/taste/*`), and a11y (`../_resources/accessibility/*`).
...
- High-fi/code artifacts pass the same token + a11y bar as the `shadcn-ui-design` skill (no hardcoded values, contrast, states).
