...
## Steps
1. Read `../_resources/content/voice-tone.md` (voice principles, tone spectrum, formulas, microcopy patterns, inclusive language, pre-ship checklist).
...
Run every line through the 10-item pre-ship checklist in `../_resources/content/voice-tone.md` — do not skip it:
...
- Within character limits; translatable (no concatenation — see `../_resources/accessibility/i18n-rtl.md`).
